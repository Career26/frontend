...
export const mockCardData: CardInformation[] = [1, 2, 3, 4, 5, 6, 7].map((i) => ({
  id: String(i),
...
export const mockCareersTest: CareersResponse = {
  career_paths: {
    ...
    '55c0677b-dc68-4231-a765-08b00cb826ea': {
      companies: ['Bloomberg', 'BlackRock', 'Fidelity Investments', 'Morgan Stanley'],
      industry: 'Finance',
      reason:
        'Combining your interest in finance and technology, along with your programming skills, a career as a Financial Software Developer would be a suitable choice. This role allows you to work independently and develop software solutions for the finance industry.',
      role: 'As a Financial Software Developer, you will design and implement software applications specifically for the finance industry. You will work on developing trading platforms, risk management systems, and financial modeling tools.',
      skills: [
        'Finance knowledge',
    ...
    '949540b9-5501-430a-8820-966c0239a556': {
      companies: ['Microsoft', 'Google', 'Facebook', 'Amazon'],
      industry: 'Technology',
      reason:
        'With your Computer Science background and experience in developing real-world applications, a career as a Software Engineer would be a suitable choice. You will have the opportunity to work independently and utilize your programming skills.',
      role: 'As a Software Engineer, you will be responsible for designing, coding, and testing software applications. You will work on developing new features, debugging issues, and improving existing software systems.',
      skills: [
